...
**Generated:** 2026-08-10 · **Revised:** 2026-09-17
**Status:** Evidence-based, verified against codebase. Architecture ratified as ADR-10.
**Document set version:** 2.0.0

**What changed in 2.0.0.** Full 1-to-1 synchronization with the active desktop codebase: (a) Added PRDs 46–51 documenting Extended Metadata Enrichment (AniList/TVMaze/Wikidata/Wiki), Native Provider & OTT Platform Aggregation, Multi-Engine Download & Verified Resume, Anti-Bot Challenge Solving, Runtime Provisioning & Sidecar Lifecycle, and Push Search with Multi-Profile Scopes; (b) Updated PRDs 33, 34, 40.1, 42 to match the as-built React 19, Java 21 Sidecar Gen 14, and 4-tier media engine implementations.
...
| 39 | [39-native-extension-and-playback-standards.md](39-native-extension-and-playback-standards.md) | **Our own extension standard, and the playback contract behind it** — the four-lane provider model (.cs3 / .csx / addon URL / yt-dlp), the Source and manifest wire formats, repository signing, the engine ladder and format matrix, and the TLS/challenge layer that actually decides site coverage |
| 40 | [40-CloudStream 3 Desktop Universal Media Compatibility and Adaptive Playback Engine PRD.md](40-CloudStream%203%20Desktop%20Universal%20Media%20Compatibility%20and%20Adaptive%20Playback%20Engine%20PRD.md) | Universal Media Compatibility and Adaptive Playback Engine Master PRD |
| 40.1 | [40.1-playback-reliability-observability-and-routing-baseline.md](40.1-playback-reliability-observability-and-routing-baseline.md) | **Playback Reliability, Observability & Routing Baseline** — stream lease manager, playback telemetry, and failure failover |
| 41 | [41-desktop-extension-platform-and-community-standard.md](41-desktop-extension-platform-and-community-standard.md) | **The Desktop Extension Platform, and a community standard of our own** — the five-lane provider model (`.cs3` / upstream cross-platform `.csj` jar / our `.csx` / Stremio addon URL / yt-dlp rule), CSX-REPO + CSX-EXT + CSX-SDK, ed25519 signing with pinned keys, the capability sandbox, the unified metadata model (multi-source ratings, crew, chapters, typed artwork), the developer CLI and fixture harness, and the publishing/governance model |
| 42 | [42-resume-continuity-and-seekable-sources.md](42-resume-continuity-and-seekable-sources.md) | **Resume, continuity, and sources that cannot seek** — resume decision engine, series context progression, Range probing, and played source memory |
| 43 | [43-source-and-provider-expansion.md](43-source-and-provider-expansion.md) | **Source and provider expansion** — provider roster, live index surveys, and direct HTTP link handling |
| 44 | [44-user-and-developer-experience-research-and-roadmap.md](44-user-and-developer-experience-research-and-roadmap.md) | **User and developer experience research** — failure taxonomy, error states, and UX roadmap |
| 45 | [45-new-source-integration-movies-series-documentaries.md](45-new-source-integration-movies-series-documentaries.md) | **New source integration** — movie, series, and documentary source assessments |
| 46 | [46-extended-metadata-and-multi-source-title-enrichment.md](46-extended-metadata-and-multi-source-title-enrichment.md) | **Extended Metadata & Title Enrichment Subsystem** — multi-source integration (AniList GraphQL, TVMaze REST, Wikidata SPARQL, Wikipedia API, Cinemeta) with deterministic confidence merging and non-blocking push updates |
| 47 | [47-native-providers-and-ott-platform-catalog-engine.md](47-native-providers-and-ott-platform-catalog-engine.md) | **Native Providers Lane & OTT Platform Catalog Engine** — Stremio v3 manifest addons, Jellyfin/Emby servers, 10+ streaming platform catalogs (Netflix, Prime, Disney+), and zero-latency page snapshot caching |
| 48 | [48-multi-engine-download-and-verified-resume-subsystem.md](48-multi-engine-download-and-verified-resume-subsystem.md) | **Multi-Engine Download & Verified Resume Subsystem** — 5-engine orchestrator (aria2c RPC, FastDownloader chunk hashing, yt-dlp, HTTP fallback, WebTorrent) with socket Range probes and verified resume state machines |
| 49 | [49-security-anti-bot-challenge-and-session-interception.md](49-security-anti-bot-challenge-and-session-interception.md) | **Security, Anti-Bot Challenge Solving & Headless Interception** — invisible WebContents solver for Cloudflare Turnstile/IUAM/DDoS-Guard with cookie sync to Node/JVM OkHttp, diagnostic privacy redaction, and in-memory adult mode gates |
| 50 | [50-runtime-provisioning-sidecar-lifecycle-and-extension-recovery.md](50-runtime-provisioning-sidecar-lifecycle-and-extension-recovery.md) | **Runtime Provisioning, Sidecar Lifecycle & Extension Recovery Engine** — Generation-stamped runtime synchronization (Generation 14), Java 21 sidecar supervision, safe auto-updates with rollback, and 8-shape failure taxonomy |
| 51 | [51-push-search-multi-profile-scope-and-aggregation-engine.md](51-push-search-multi-profile-scope-and-aggregation-engine.md) | **Push Search, Multi-Profile Scopes & Real-Time Aggregation Engine** — streaming push search sessions, concurrency capping, host deadline circuit breakers, multi-profile source scopes, and search deduplication |
